...
class WYSIJA_help_install extends WYSIJA_object{
    ...
    function install(){
        ...
        $this->testNLplugins();
        $this->wp_notice(str_replace(array('[link]','[/link]'),array('<a href="admin.php?page=wysija_config">','</a>'),__("Wysija has been installed with success. Go to it's [link]settings page[/link] now, and start blasting emails.",WYSIJA)));
    ...
    function defaultCampaign($valuesconfig){
        ...
        $campaign_id=$modelCampaign->insert(
                array(
                    ...
                    "description"=>__('Default Campaign created automatically during installation.',WYSIJA),
        ...
        $newparams=unserialize(base64_decode($dataEmail['params']));
        $newparams['quickselection']['wp-301']['url']=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_07.png";
        $newparams['quickselection']['wp-301']['thumb_url']=WYSIJA_EDITOR_IMG."default-newsletter/sample-newsletter-01_07-150x150.png";
        $newparams['quickselection']['wp-302']['url']=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_10.png";
        $newparams['quickselection']['wp-302']['thumb_url']=WYSIJA_EDITOR_IMG."default-newsletter/sample-newsletter-01_10-150x30.png";
        $newparams['quickselection']['wp-303']['url']=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_14.png";
        $newparams['quickselection']['wp-303']['thumb_url']=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_14.png";
        $newparams['quickselection']['wp-304']['url']=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_16.png";
        $newparams['quickselection']['wp-304']['thumb_url']=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_16.png";
        $newparams['quickselection']['wp-305']['url']=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_21.png";
        $newparams['quickselection']['wp-305']['thumb_url']=WYSIJA_EDITOR_IMG."default-newsletter/sample-newsletter-01_21-150x16.png";
        $newparams['quickselection']['wp-306']['url']=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_25.png";
        $newparams['quickselection']['wp-306']['thumb_url']=WYSIJA_EDITOR_IMG."default-newsletter/sample-newsletter-01_25-150x150.png";
        $newparams['quickselection']['wp-307']['url']=WYSIJA_EDITOR_IMG."default-newsletter/full/white-label-logo.png";
        $newparams['quickselection']['wp-307']['thumb_url']=WYSIJA_EDITOR_IMG."default-newsletter/full/white-label-logo.png";
        $dataEmail['params']=base64_encode(serialize($newparams));

        $newwjdata=unserialize(base64_decode($dataEmail['wj_data']));
        $newwjdata["header"]["image"]["src"]=WYSIJA_EDITOR_IMG."default-newsletter/full/white-label-logo.png";
        $newwjdata["body"]["block-3"]["image"]["src"]=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_07.png"; 
        $newwjdata["body"]["block-5"]["image"]["src"]=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_14.png"; 
        $newwjdata["body"]["block-8"]["image"]["src"]=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_10.png"; 
        $newwjdata["body"]["block-10"]["image"]["src"]=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_21.png"; 
        $newwjdata["body"]["block-13"]["image"]["src"]=WYSIJA_EDITOR_IMG."default-newsletter/full/sample-newsletter-01_25.png"; 
        $dataEmail['wj_data']=base64_encode(serialize($newwjdata));
