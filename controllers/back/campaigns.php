...
class WYSIJA_control_back_campaigns extends WYSIJA_control_back{
    ...
    function welcome_new(){
        ...
        $hReadme->scan();
        $this->data=array();
        $this->data['abouttext']='Thanks for installing wysija. We hope you\'ll like it!';
        $mConfig=&WYSIJA::get('config','model');
        $mConfig->save(array('wysija_whats_new'=>WYSIJA::get_version()));
        $this->data['sections'][]=array(
            'title'=>'Trying for the First Time?',
            'format'=>'normal',
            'paragraphs'=>array(
                    "Trying for the first time? Watch this 5 minute intro on Wysija by one of our users.",
        ...
        $this->data['sections'][]=array(
            ...
            'cols'=>array(
                array(
                    'title'=>"HTML Subscription Form ",
                    'content'=>"Find the HTML version of your subscription form in the widget, just like the iframe and the php versions."
            ),
                array(
                    'title'=>'Dozens of bug fixes',
                    'content'=>'Thanks to all our users for reporting issues to us. We work hard on making your experience smooth across the board.'
            ),
                array(
                    'title'=>'Nearly 200 ratings',
                    'content'=>"We're 10 ratings shy of getting a total of 200 ratings. This means a lot to us. ".'<a href="http://wordpress.org/support/view/plugin-reviews/wysija-newsletters" target="_blank" title="On our blog!">Add your own!</a>'
            )
            ),
            'format'=>'three-col',
            );
        $this->data['sections'][]=array(
            'title'=>'Keep Wysija & WP Updated',
            'format'=>'normal',
            'paragraphs'=>array(
                    "We noticed a few users are not updating their plugins. Or their WordPress. For security reasons, both should be kept updated with the latest version."
                )
            );
