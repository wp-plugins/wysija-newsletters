...
class WYSIJA_control_back_campaigns extends WYSIJA_control_back{
    ...
    function pause(){
        ...
        if(isset($_REQUEST['id']) && $_REQUEST['id']){
            ...
            $this->notice(__("The campaign queue has been paused.",WYSIJA));
        }
    ...
    function resume(){
        ...
        if(isset($_REQUEST['id']) && $_REQUEST['id']){
            ...
            $this->notice(__("The campaign queue has been resumed.",WYSIJA));
        }
    ...
    function duplicate(){
        ...
        $this->notice(__("The campaign has been duplicated.",WYSIJA));
    ...
    function delete(){
     ...
     function savecamp(){
        ...
        if(isset($_REQUEST['id'])){
            ...
            $newparams=unserialize(base64_decode(""));
    ...
    function savelast(){
        ...
        if(isset($_POST['submit-draft']) || isset($_POST['submit-pause'])){
            $this->notice(__("Campaign has been saved as a draft.",WYSIJA));
        }else{
            ...
            $this->notice(__("Campaign is being sent.",WYSIJA));
    ...
    function defaultDisplay(){
        ...
        $this->jsTrans["selecmiss"]=__('Please select some campaigns first!',WYSIJA);
        $this->jsTrans['suredelete']=__("Delete this newsletter for ever?",WYSIJA);
        $this->jsTrans['processqueue']=__("Queue sending process.",WYSIJA);
        ...
        if($campaign_ids){
            ...
            if($campaign_ids_sent){
                ...
                $timesec=$schedules[$modelC->getValue('sending_emails_each')]['interval'];
                $status_sent_complete=array();
 
               foreach($this->data['sent'] as $key => $camp){

                    if($this->data['sent'][$key]['left']>0){
                        $this->data['sent'][$key]['remaining_time']= ceil($this->data['sent'][$key]['left']/$modelC->getValue('sending_emails_number'))*$timesec;
                    }else{
    ...
    function createnewlist(){
        ...
        $listid=$modelL->insert(array("is_enabled"=>1,"name"=>$listname,"description"=>__("List created based on a campaign segment.",WYSIJA)));
