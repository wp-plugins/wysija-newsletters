...
class WYSIJA_control extends WYSIJA_object{
    ...
    function WYSIJA_control(){
        ...
        if(isset($_REQUEST['_wpnonce'])){
           ...
           if(!wp_verify_nonce($nonce, $actionnonce) ) die(__("Security failure during request.")); 
        }
    }
    ...
    function requireSecurity(){
        ...
        if(!isset($_REQUEST['wpnonceback'])) {
           die(__("Your request is not safe."));
        }else{
            return true;
        }
